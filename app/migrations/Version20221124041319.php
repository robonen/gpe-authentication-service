 ...
 */
final class Version20221124041319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE access_token ADD user_id INT NOT NULL, ADD token VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE access_token DROP user_id, DROP token');
    }
}
